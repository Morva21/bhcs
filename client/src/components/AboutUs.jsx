  ...
  return (
    ...
    <div className='container mx-auto h-full font-semibold'>
     ...
     <div className="md:order-1">
                ...
                <div >
                    <h1 className="h1 mb-6 md:mr-40 text-accent">About Us.</h1>
              ...
              <div className="md:order-2 mt-3">
                <p>
                At Bernadette Home Care Services, we believe every life is precious and deserving of utmost care and compassion.  As a dedicated care provide, we are committed to enhancing the lives our our clients and have been doing so for many years.  

Our Mission is to provide unparalleled support and comfort to every one, ensuring they lead fulfilling lives in the comfort of their homes.  We will provide a customized plan that will change as your loved one need change.  We provide short and long term, overnight and twenty-four hour care.  We will travel to all areas to meet your needs and we are committed 100% to our clients.  With a team of highly trained and compassionate caregivers, we offer a warm and nurturing care where everyone will feel valued, respected and cherished. 
                </p>
                <div className='mt-6'>
                  <h2 className='h2 text-accent'>Our Values</h2>
                  <p>
We live by our core values and tirelessly promote them at all levels. Responding at a moment's notice. Integrity without compromise. 
Celebrating an improved quality of life. Fostering a positive attribute.</p>
                </div>
              </div>
     </div> */}
